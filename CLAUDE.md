# garjan — Claude Code Instructions

## Project Identity

**garjan** (Sanskrit: roar / thunder) — Environmental and nature sound synthesis for AGNOS
...
kiran (game engine), joshua (game manager), dhvani (audio engine), and any AGNOS component needing environmental audio.

## Dependencies

- **hisab**: Math library (FFT, easing, RNG, compensated summation)
- **naad**: Audio synthesis primitives (optional, via feature flag)
...
5. External research — acoustics, physical modeling, psychoacoustics
